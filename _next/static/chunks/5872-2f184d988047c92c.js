  ...
  [5872],
  {
    65415: function (t, e) {
      ...
      (e.byteLength = function (t) {
        ...
        (e.fromByteArray = function (t) {
          for (
            var e, n = t.length, f = n % 3, i = [], o = 0, u = n - f;
            o < u;
            o += 16383
          )
            i.push(
              (function (t, e, n) {
                for (var f, i = [], o = e; o < n; o += 3)
                  i.push(
                    r[
                      ((f =
                        ((t[o] << 16) & 16711680) +
    ...
    55872: function (t, e, r) {
      ...
      function fromArrayLike(t) {
        let e = t.length < 0 ? 0 : 0 | checked(t.length),
          r = createBuffer(e);
            ...
            case "utf-16le":
              return (function (t, e, r) {
                ...
                for (let t = 0; t < n.length - 1; t += 2)
                  f += String.fromCharCode(n[t] + 256 * n[t + 1]);
                return f;
              })(this, e, r);
            default:
      ...
      function bidirectionalIndexOf(t, e, r, n, f) {
        ...
        if (
          ("string" == typeof e && (e = Buffer.from(e, n)), Buffer.isBuffer(e))
        )
      ...
      (e.Buffer = Buffer),
        ...
        (Buffer.concat = function (t, e) {
          ...
          for (r = 0; r < t.length; ++r) {
            ...
            if (isInstance(e, Uint8Array))
              f + e.length > n.length
                ? (Buffer.isBuffer(e) || (e = Buffer.from(e)), e.copy(n, f))
                : Uint8Array.prototype.set.call(n, e, f);
            else if (Buffer.isBuffer(e)) e.copy(n, f);
            ...
            switch (n) {
              case "hex":
                return (function (t, e, r, n) {
                  ...
                  for (n > o / 2 && (n = o / 2), f = 0; f < n; ++f) {
                    let n = parseInt(e.substr(2 * f, 2), 16);
                    if (n != n) break;
                    t[r + f] = n;
                  }
                  return f;
              ...
              case "utf-8":
                return (
                  (f = e),
                  (i = r),
                  blitBuffer(utf8ToBytes(t, this.length - f), this, f, i)
                );
              case "ascii":
              case "latin1":
              case "binary":
              ...
              case "base64":
                return (
                  (s = e), (h = r), blitBuffer(base64ToBytes(t), this, s, h)
                );
              case "ucs2":
              case "ucs-2":
              case "utf16le":
        ...
        (Buffer.prototype.readBigUInt64LE = defineBigIntMethod(function (t) {
          ...
          let n =
            ...
            f = this[++t] + 256 * this[++t] + 65536 * this[++t] + 16777216 * r;
        ...
        (Buffer.prototype.readBigUInt64BE = defineBigIntMethod(function (t) {
          ...
          let n =
            ...
            f = 16777216 * this[++t] + 65536 * this[++t] + 256 * this[++t] + r;
        ...
        (Buffer.prototype.writeIntLE = function (t, e, r, n) {
          ...
          for (this[e] = 255 & t; ++f < r && (i *= 256); )
            t < 0 && 0 === o && 0 !== this[e + f - 1] && (o = 1),
              (this[e + f] = (((t / i) >> 0) - o) & 255);
          return e + r;
        }),
        ...
        (Buffer.prototype.fill = function (t, e, r, n) {
          ...
          if (
            ...
            let i = Buffer.isBuffer(t) ? t : Buffer.from(t, n),
              o = i.length;
            if (0 === o)
              throw TypeError(
      ...
      function checkIntBI(t, e, r, n, f, i) {
        ...
        validateNumber(f, "offset"),
          (void 0 === n[f] || void 0 === n[f + i]) &&
            boundsError(f, n.length - (i + 1));
      }
      ...
      function blitBuffer(t, e, r, n) {
        let f;
        for (f = 0; f < n && !(f + r >= e.length) && !(f >= t.length); ++f)
          e[f + r] = t[f];
        return f;
      }
          ...
          for (
            isNaN((e = Math.abs(e))) || e === 1 / 0
              ...
              : ((o = Math.floor(Math.log(e) / Math.LN2)),
                ...
                o + c >= 1 ? (e += l / s) : (e += l * Math.pow(2, 1 - c)),
                e * s >= 2 && (o++, (s /= 2)),
                o + c >= a
                  ? ((u = 0), (o = a))
                  : o + c >= 1
                  ? ((u = (e * s - 1) * Math.pow(2, f)), (o += c))
                  : ((u = e * Math.pow(2, c - 1) * Math.pow(2, f)), (o = 0)));
            f >= 8;
